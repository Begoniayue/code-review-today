...
import { getScreen, downBlobFile,downFileBlob } from '@/util/index.js'
import { jsonToExcel } from '@/util/json2Excel.js'
...
app.config.globalProperties.downFileBlob = downFileBlob
